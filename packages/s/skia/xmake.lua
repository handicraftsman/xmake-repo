package("skia")
    ...
    local commits = {["88"] = "158dc9d7d4cafb177b99b68c5dc502f8f4282092",
                     ...
                     ["117"] = "26ce945468bd635624e76ff8a1f964284f16b33f"}
    ...
    add_versions("117", "0f45e089c6d5b5789bdaa18cda08a75bbf864de85651324f97d714ff32ac310b")
    ...
    on_install("macosx", "linux", "windows", function (package)
        ...
        io.replace("gn/skia/BUILD.gn", "libs += [ \"pthread\" ]", "libs += [ \"pthread\", \"m\", \"stdc++\" ]", {plain = true})
        ...
        if #cflags > 0 then
            io.replace("gn/skia/BUILD.gn", "cflags = []", 'cflags = ["' .. table.concat(cflags, '", "') .. '"]', {plain = true})
        end
        if #ldflags > 0 then
            io.replace("gn/skia/BUILD.gn", "ldflags = []", 'ldflags = ["' .. table.concat(ldflags, '", "') .. '"]', {plain = true})
        end
